...
"[project]/node_modules/dinjs/dist/index.mjs [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function dinjs_CONVERT_TO_BS(dinjs_Format, dinjs_YEAR, dinjs_MONTH, dinjs_DATE) {
    const dinjs_REFRENCE_DATE = new Date(dinjs_NEPALI_CALENDER.dinjs_REFRENCEDATE_BAISAKH_1_YEAR_START);
    const dinjs_AD_DATE = new Date(dinjs_FORMAT_DATE("YYYY-MM-DD", dinjs_YEAR, dinjs_MONTH, dinjs_DATE));
    ...
    return dinjs_FORMAT_DATE(dinjs_Format, dinjs_NEPALI_YEAR, dinjs_NEPALI_MONTH, dinjs_NEPALI_DATE);
}
...
//# sourceMappingURL=node_modules_059ee8ac._.js.map