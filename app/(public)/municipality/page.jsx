    ...
    <>
      ...
      <div className="flex-4/5 ">
        <div>
          ...
          <Titlebar title="मेन्छयायेम गान" />

          <div className="flex justify-center">
            <div className="w-full md:w-2/3 text-center">
              <pre className="whitespace-pre-wrap text-lg leading-relaxed py-1 pl-2 pb-3 md:text-xl inline-block text-left">
                {song}
              </pre>

              <div className="flex justify-center mt-2">
                <audio controls className=" md:w-1/3">
