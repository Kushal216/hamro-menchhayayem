...
const Menubar = ({ closeMenu }) => {
  ...
  return (
    <>
      <nav className="border border-[#00000000] box-border min-w-fit text-xl shadow-xl bg-white md:bg-[#cacaca] rounded-b-xl w-fit fixed md:static md:h-screen right-0">
