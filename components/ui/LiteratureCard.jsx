...
export default function LiteratureCard({
  ...
  return (
    <Link href={`/literature/${id}`} className="block">
      <div className="p-5 py-3 mx-2 flex flex-col justify-between h-full w-full bg-white rounded-2xl shadow-lg hover:shadow-xl hover:-translate-y-0.5 transition-all cursor-pointer">
        ...
        <div className="px-4 pb-4 sm:px-5 sm:pb-5">
          ...
          <div className="flex sm:flex-row items-center justify-between gap-4 mt-5">
            <span className="w-full text-lg bg-purple-800 text-white font-bold rounded-2xl px-5 py-2 text-center flex items-center justify-center gap-2">
              <BiBookOpen size={18} />
              साहित्य पढ्नुहोस्
            </span>
